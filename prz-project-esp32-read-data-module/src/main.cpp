...
String *sendAnalogOutputString()
{
  String stringStartCharacter = "$";
  String stringEndCharacter = "#";
  String *l = analogReadAverage();
  String txString = stringStartCharacter;
  txString += "V_S:";
  txString += l[0];
  txString += ";V_C:";
  txString += l[1];
  ...
  txString += ";ALL:";
  txString += l[8];
  txString += stringEndCharacter;
  String *fString = &txString;
  return fString;
}
void setup()
{
